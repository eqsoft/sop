...
var cs = (Cu.import("resource://gre/modules/devtools/Console.jsm", {})).console;
...
/**
 * handle callback if typeof = function, else ignore call 
 * 
 * @public
 * @method handle
 * @param {Function} fn
 * @param {any} param
 * @ctx {Object} ctx=null context of function call
 * @return false if fn is not a function
 **/ 
function handle(fn,param,ctx=null) {
...
/**
 * get formatted time fro seconds (hh:mm:ss)
 * 
 * @public
